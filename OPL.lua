...
wait()
game.Players.LocalPlayer.Character:MoveTo(Vector3.new(-133.806, 215.5, -668.598022, 0.573598742, 0, 0.81913656, 0, 1, 0, -0.81913656, 0, 0.573598742))
wait(.2)
 game.Players.LocalPlayer.Character:MoveTo(Vector3.new(3.08866906, 218.500168, -414.068237, -0.707134247, 0, -0.707079291, 0, 1, 0, 0.707079291, 0, -0.707134247))
wait(.2)
 game.Players.LocalPlayer.Character:MoveTo(Vector3.new(620.75, 215.600021, 1217.75, 0, 0, 1, 0, 1, -0, -1, 0, 0))
wait(.2)
