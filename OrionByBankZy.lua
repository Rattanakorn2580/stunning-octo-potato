...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "OPlium Hub By Bank Kesee"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "OPlium Hub By Bank Kesee"
	...
	local TabHolder = AddThemeObject(SetChildren(SetProps(MakeElement("ScrollFrame", Color3.fromRGB(27, 42, 53), 4), {
