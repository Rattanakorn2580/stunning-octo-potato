local whitelist = { 
    "T3T_XxBankKungxX",  -- เปลี่ยนเป็นชื่อผู้เล่นที่ต้องการอนุญาต
    "Bankzy_idFind",  
    "ICU_XxWhiteknightxX"
}
