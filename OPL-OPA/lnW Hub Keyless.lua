...
spawn(function()
	...
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(71, 217, -917)
            ...
            wait(.5)
           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(59, 222, -262)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-65, 216, -293)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(33, 223, -19)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-363, 229, -487)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-426, 215, -205)
            wait(.5)
           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-248, 274, 353)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1177, 222, -1583)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1201, 253, -1649)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1299, 248, -1651)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1337, 248, -1640)
            wait(.5)
           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1267, 266, -1780)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1423, 257, -1663)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1842, 224, -451)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1913, 230, -297)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1902, 229, -219)
            wait(.5)
           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1734, 224, -145)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1609, 228, -201)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1007, 221, 3341)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1004, 324, 1689)
            wait(.5)
           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-901, 216, 1633)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-982, 286, 1607)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1063, 216, 1504)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1207, 217, -254)
            wait(.5)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1164, 216, -256)
            wait(.5)
           game.Players.LocalPlayer.Charactor.HumanoidRootPart.CFrame = CFrame.new(2169, 215, -630)
	    wait(.5)
            end
        end)
    end
