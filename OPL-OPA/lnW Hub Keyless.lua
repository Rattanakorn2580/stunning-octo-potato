...
spawn(function()
    while wait() do
        if BringPlr then
            pcall(function()
                game.Players[SelectPlayer].Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(0,0,-1.5)
            end)
        end
    end
end)
...
spawn(function() 
    while wait() do
        if _G.antistun then
            pcall(function()
                for i,v in pairs(game.workspace.ResourceHolder:GetChildren()) do
                    if v.Name ~= game.workspace.ResourceHolder["Resources_" .. game.Players.LocalPlayer.UserId] then
                     v.MagmaPool.TouchInterest:Destroy()
                    end
                end
            end)
        end
