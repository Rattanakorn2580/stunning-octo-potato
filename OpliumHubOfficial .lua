...
while _G.antistun do wait()
	...
	if _G.antistun then
       ...
       khiemquadeptrai.Returned.Value = true
       khiemquadeptrai.Hobbied.Value = true
       khiemquadeptrai.HMS.Value = true
       khiemquadeptrai.ChillyPunched.Value = true
       khiemquadeptrai.CandyTouched.Value = true
       khiemquadeptrai.Negative.Value = true
       khiemquadeptrai.OpeSevered.Value = true
       khiemquadeptrai.SnowTouched.Value = true
       khiemquadeptrai.RumbleStun.Value = true
       khiemquadeptrai.GravityCrushed.Value = true
